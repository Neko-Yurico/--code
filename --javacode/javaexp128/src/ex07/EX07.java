...
class MyCalc extends JFrame {
    public MyCalc ( ) {
        ...
        bCalc.setFont ( new Font ( "SERIF" , Font.PLAIN , 30 ) );
        
        JButton bCle = new JButton ( "clear" );
        bCle.setFont ( new Font ( "SERIF" , Font.PLAIN , 30 ) );
        ...
        bCle.addActionListener ( e -> input.setText ( "" ) );
        
        setVisible ( true );
    }
    
    static class MathThread implements Runnable {
        JTextField input;
